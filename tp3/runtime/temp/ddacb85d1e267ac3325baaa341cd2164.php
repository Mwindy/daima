<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"H:\WWW\tp3\public/../application/admin\view\admin\modify.html";i:1576069690;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576205875;}*/ ?>
﻿<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                     <form class="form-horizontal" role="form" action="<?php echo url('admin/update'); ?>" method="post" name="result">
