<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"H:\WWW\tp3\public/../application/admin\view\bbs\bbs_add.html";i:1576133828;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576129493;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" name="result">
						...
						<div class="form-group">
						    <label for="content" class="col-sm-2 control-label no-padding-right">公告内容</label>
						    <div class="col-sm-6">
						         <textarea class="form-control" id="content" placeholder="" name="content" required rows="5" cols="50" style="font-size:35px;"></textarea>
						    </div>
