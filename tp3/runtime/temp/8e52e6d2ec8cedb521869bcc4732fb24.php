<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"H:\WWW\tp3\public/../application/admin\view\more\goods_one.html";i:1576466894;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576205875;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">商品详细信息</span>
            </div>
                ...
                <div id="horizontal-form">
                     <form class="form-horizontal" role="form" action="" method="post" name="result">
							...
							<div class="form-group">
                                <label for="goodsname" class="col-sm-2 control-label no-padding-right"></label>
                                <div class="col-sm-6">
									<img id="picture" name="picture" src="http://localhost:8080/tp3/public/static/admin/images/<?php echo $result['picture']; ?>" style="width:250px;height:300px;"/>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="goodsname" placeholder="" name="goodsname" required type="text" value="<?php echo $result['goodsname']; ?>" style="width: 200px;height: 34px;">
                                </div>
                                <p class="help-block col-sm-4 red">&nbsp;</p>
                            </div>
                         ...
                         <textarea id="introduce" placeholder="" name="introduce" required rows="4" cols="45" style="font-size: 35px;"><?php echo $result['introduce']; ?></textarea>
                                </div>
                                 <p class="help-block col-sm-4 red">&nbsp;</p>
                            </div>  
                             <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="price" placeholder="" name="price" required type="text" value="<?php echo $result['price']; ?>" style="width: 160px;height: 34px;">
                               ...
                               <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="nowPrice" placeholder="" name="nowPrice" required type="text" value="<?php echo $result['nowPrice']; ?>" style="width: 160px;height: 34px;">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="submit" class="btn btn-default"><a href="<?php echo url('index/goods'); ?>">返回</a></button>
                                </div>
                            </div>
                    </form>
                </div>
