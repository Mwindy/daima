<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"H:\WWW\tp3\public/../application/admin\view\bbs\modify.html";i:1576133755;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576133983;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改公告信息</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                     <form class="form-horizontal" role="form" action="<?php echo url('bbs/update'); ?>" method="post" name="result">
                          <div class="form-group">
                            <label for="title" class="col-sm-2 control-label no-padding-right">公告标题</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="title" placeholder="" name="title" required type="text" value="<?php echo $result['title']; ?>">
                            </div>
