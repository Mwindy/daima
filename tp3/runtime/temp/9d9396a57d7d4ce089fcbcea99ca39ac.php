<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"H:\WWW\tp3\public/../application/admin\view\more\service_one.html";i:1576129072;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576205875;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">客服详细信息</span>
            </div>
                    ...
                    <form class="form-horizontal" role="form" action="" method="post" name="result">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" class="btn btn-default"><a href="<?php echo url('index/service'); ?>">返回</a></button>
                            </div>
                        </div>
                    </form>
                </div>
