<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"H:\WWW\tp3\public/../application/admin\view\more\order_one.html";i:1576497588;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576205875;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('index/order'); ?>">订单信息列表</a>
                    </li>
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">订单详细信息</span>
            </div>
                ...
                <div id="horizontal-form">
                    ...
                    <form class="form-horizontal" role="form" action="" method="post" name="result">
                          <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="truename" placeholder="" name="truename" required type="text" value="<?php echo $result['truename']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">&nbsp;</p>
                        </div>

                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">送往城市</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="address" placeholder="" name="address" required type="text" value="<?php echo $result['address']; ?>">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="postcode" placeholder="" name="postcode" required type="text" value="<?php echo $result['postcode']; ?>">
                     
                            </div>
                              <p class="help-block col-sm-4 red">&nbsp;</p>
                           </div>
                           <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">配送方式</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="carry" placeholder="" name="carry" required type="text" value="<?php echo $result['carry']; ?>">
                     
                            </div>
                              <p class="help-block col-sm-4 red">&nbsp;</p>
                           </div>
                           <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">支付方式</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="pay" placeholder="" name="pay" required type="text" value="<?php echo $result['pay']; ?>">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="tel" placeholder="" name="tel" required type="text" value="<?php echo $result['tel']; ?>">
						         ...
						         <div class="widget">
						                 ...
						                 <div class="flip-scroll">
						                     <table class="table table-bordered table-hover">
						                         <thead class="">
						                             <tr>
						                                 <th class="text-center">商品编号ID</th>
						                         ...
						                         <tbody>
						                <?php if(is_array($result1) || $result1 instanceof \think\Collection || $result1 instanceof \think\Paginator): if( count($result1)==0 ) : echo "" ;else: foreach($result1 as $key=>$result2): ?>                                    
						  <tr height="50px">
						 <td align="center"><?php echo $result2['id']; ?></td><td align="center"><?php echo $result2['goodsname']; ?></td>
						 <td align="center"><?php echo $result2['price']; ?></td> <td align="center"><?php echo $result2['number']; ?></td>
						 </tr>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						                                                     </tbody>
						                     </table>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" class="btn btn-default"><a href="<?php echo url('index/order'); ?>">返回</a></button>
                            </div>
                        </div>
                    </form>
                </div>
