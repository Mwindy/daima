<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"H:\WWW\tp3\public/../application/admin\view\index\goods.html";i:1576153829;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576205875;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('goods/goods_add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
 ...
 <tr>
<td align="center"><?php echo $vo['id']; ?></td><td align="center"><a href="<?php echo url('more/goods_one',array('id'=>$vo['id'])); ?>"><?php echo $vo['goodsname']; ?></a></td>
<td align="center">
 <a href="<?php echo url('goods/modify',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny"><i class="fa fa-edit"></i> 编辑</a>
<?php if($vo['id'] != 1): ?> <a href="#" onClick="warning('确定要删除吗', '<?php echo url('goods/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
