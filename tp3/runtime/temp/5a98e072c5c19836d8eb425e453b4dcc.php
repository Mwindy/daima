<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"H:\WWW\tp3\public/../application/admin\view\more\bbs_one.html";i:1576133783;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576205875;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('index/bbs'); ?>">公告信息列表</a>
                    </li>
                                        <li class="active">公告详细信息</li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">公告详细信息</span>
            </div>
                ...
                <div id="horizontal-form">
                    ...
                    <form class="form-horizontal" role="form" action="" method="post" name="result">
                          <div class="form-group">
                            <label for="title" class="col-sm-2 control-label no-padding-right">公告标题</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="title" placeholder="" name="tilte" required type="text" value="<?php echo $result['title']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                              <textarea class="form-control" id="content" placeholder="" name="content" required rows="5" cols="50" style="font-size:35px;"><?php echo $result['content']; ?></textarea>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" class="btn btn-default"><a href="<?php echo url('index/bbs'); ?>">返回</a></button>
                            </div>
                        </div>
                    </form>
                </div>
