<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"H:\WWW\tp3\public/../application/admin\view\goods\modify.html";i:1576205667;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576205875;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改商品信息</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                     <form class="form-horizontal" role="form" action="<?php echo url('goods/update'); ?>" method="post" name="result">
