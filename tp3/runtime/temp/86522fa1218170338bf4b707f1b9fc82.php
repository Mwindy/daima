<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"H:\WWW\tp3\public/../application/admin\view\service\modify.html";i:1576128938;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576133983;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改客服信息</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                     <form class="form-horizontal" role="form" action="<?php echo url('service/update'); ?>" method="post" name="result">
