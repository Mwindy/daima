<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"H:\WWW\tp3\public/../application/admin\view\index\lst.html";i:1576127799;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576205875;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('admin/lst_add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">管理员用户名</th>
 ...
 <tr>
<td align="center"><?php echo $vo['id']; ?></td><td align="center"><a href="<?php echo url('more/lst_one',array('id'=>$vo['id'])); ?>"><?php echo $vo['username']; ?></a></td>
<td align="center">
 <a href="<?php echo url('admin/modify',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny"><i class="fa fa-edit"></i> 编辑</a>
<?php if($vo['id'] != 1): ?> <a href="#" onClick="warning('确定要删除吗', '<?php echo url('admin/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
