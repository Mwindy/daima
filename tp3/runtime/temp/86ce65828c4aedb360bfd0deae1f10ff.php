<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"H:\WWW\tp3\public/../application/admin\view\more\user_one.html";i:1576129111;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576205875;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('index/user'); ?>">会员信息列表</a>
                    </li>
                                        <li class="active">会员详细信息</li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">会员详细信息</span>
            </div>
                ...
                <div id="horizontal-form">
                    ...
                    <form class="form-horizontal" role="form" action="" method="post" name="result">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="city" placeholder="" name="city" required type="text" value="<?php echo $result['city']; ?>">
                         ...
                         <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="cardType" placeholder="" name="cardType" required type="text" value="<?php echo $result['cardType']; ?>">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="cardNO" placeholder="" name="cardNO" required type="text" value="<?php echo $result['cardNO']; ?>">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="email" placeholder="" name="email" required type="text" value="<?php echo $result['email']; ?>">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" class="btn btn-default"><a href="<?php echo url('index/user'); ?>">返回</a></button>
                            </div>
                        </div>
                    </form>
                </div>
