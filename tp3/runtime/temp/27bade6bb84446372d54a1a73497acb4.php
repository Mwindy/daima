<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:61:"H:\WWW\tp3\public/../application/admin\view\more\lst_one.html";i:1575944541;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576133983;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal" role="form" action="" method="post" name="result">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" class="btn btn-default"><a href="<?php echo url('index/lst'); ?>">返回</a></button>
                            </div>
                        </div>
                    </form>
                </div>
