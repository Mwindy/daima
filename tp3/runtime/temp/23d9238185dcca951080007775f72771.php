<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:60:"H:\WWW\tp3\public/../application/admin\view\user\modify.html";i:1576070026;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576057193;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                     <form class="form-horizontal" role="form" action="<?php echo url('user/update'); ?>" method="post" name="result">
