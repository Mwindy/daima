<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"H:\WWW\tp3\public/../application/admin\view\index\user.html";i:1576127835;s:48:"H:\WWW\tp3\application\admin\view\same\left.html";i:1576205875;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<div class="row">
 ...
 <tr>
<td align="center"><?php echo $vo['id']; ?></td><td align="center"><a href="<?php echo url('more/user_one',array('id'=>$vo['id'])); ?>"><?php echo $vo['username']; ?></a></td>
<td align="center">
 <a href="<?php echo url('user/modify',array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny"><i class="fa fa-edit"></i> 编辑</a>
<?php if($vo['id'] != 1): ?> <a href="#" onClick="warning('确定要删除吗', '<?php echo url('user/del',array('id'=>$vo['id'])); ?>')" class="btn btn-danger btn-sm shiny">
